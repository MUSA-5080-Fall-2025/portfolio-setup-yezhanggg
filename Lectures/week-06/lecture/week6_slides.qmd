...
# Load Boston housing data
boston <- read_csv(here("~/Documents/GitHub/portfolio-setup-yezhanggg/Lectures/week-06/data/boston.csv"))
...
# Load neighborhood boundaries
nhoods <- read_sf(here("~/Documents/GitHub/portfolio-setup-yezhanggg/Lectures/week-06/data/BPDA_Neighborhood_Boundaries.geojson")) %>%
  st_transform('ESRI:102286')  # Match CRS!
