...
- Rows: 50,000
- Columns: 7  
- Variable types: chr and dbl
- Problematic names: Some of the names might be too long. Several words for one column is not easy to use.
...
**Your answer:** In the top left corner, one says A tibble and one says df. But I don't see any difference on how they present the data. 
...
**Your answer:** Because Year of manufacture has muiltple words that are in one name. That's the reason why we need the backticks.
