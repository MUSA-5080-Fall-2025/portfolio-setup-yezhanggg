...
sum(is.na(census_tracts$median_income))

median(census_tracts$median_income, na.rm = TRUE)
...
vulnerable_tracts <- census_tracts %>%
  ...
  filter(median_income < 31200 & pct_elderly > 21)
...
The income threshold that I chose is 31,200. Through research, the poverty guideline in 2024 for a family of four is 31,200. It would be reasonable to use this as the guideline to set for the low median household income threshold. 
...
There are 27 vulnerable tracts that meet my standard of below 31,200 income and over 21% are elderly people. 
- What percentage of PA census tracts are considered vulnerable by your definition?
0.7% of the PA census tracts are considered as vulnerable by my definition. 
